...
enum class WintertodtLocation(
    ...
    SOUTH_WEST(TILE_SW_ROOTS, TILE_SW_BRAZIER, 1620, 1622, 3996, WIDGETS_SW_PYRO, WIDGETS_SW_BURNER),
    SOUTH_EAST(TILE_SE_ROOTS, TILE_SE_BRAZIER, 1638, 1640, 3996, WIDGETS_SE_PYRO, WIDGETS_SE_BURNER),
    NORTH_EAST(TILE_NE_ROOTS, TILE_NE_BRAZIER, 1638, 1640, 4018, WIDGETS_NE_PYRO, WIDGETS_NE_BURNER),
    NORTH_WEST(TILE_NW_ROOTS, TILE_NW_BRAZIER, 1620, 1622, 4018, WIDGETS_NW_PYRO, WIDGETS_NW_BURNER),
}